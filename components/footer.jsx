            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
                    ...
                    <div className="space-y-6">
                        <h3 className="text-2xl font-bold text-white">HiCitizen Academy</h3>
                        <p className="text-base leading-relaxed">
                            Transforming lives through quality English education since 2018. Join us in your journey to English fluency.
                        </p>
                ...
                <div className="mt-16 pt-8 border-t border-gray-800 text-sm">
                    <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 max-w-4xl mx-auto">
                        <p>© {new Date().getFullYear()} HiCitizen Academy. All rights reserved.</p>
...
const quickLinks = [
    ...
    { name: 'Our Programs', href: '#features' },
...
const contactInfo = [
    {
        icon: '📍',
        text: '123 Education Hub, Tech Park, Bangalore - 560001'
    },
    {
        icon: '📞',
        text: '+91 98765 43210'
